...
class UserProfilePage extends StatelessWidget {
  ...
  final RegistrationModel currentUser;
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    CircleAvatar(backgroundImage: FileImage(File(currentUser.image))
                    , radius: 30),
                    SizedBox(width: 10.0),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(currentUser.name, style: TextStyle(color: Colors.white, fontSize: 16.0)),
                        SizedBox(height: 5.0),
                        Text(currentUser.email, style: TextStyle(color: Colors.white, fontSize: 16.0)),
                        SizedBox(height: 5.0),
